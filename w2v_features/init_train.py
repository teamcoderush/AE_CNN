...
from w2v_features import train_with_wv as cnn
...
cnn.initiate_training(train_data_path, test_data_path, sequence_length=100, num_epochs=10, embedding_dim=100, context=20)
