...
def initiate_training(train_data_path, test_data_path,
    ...
    conv = Concatenate()(conv_blocks) if len(conv_blocks) > 1 else conv_blocks[0]

    z1 = LSTM(100, dropout=0.7, recurrent_dropout=0.5, go_backwards=False)(z)
    # z2 = LSTM(100, dropout=0.1, recurrent_dropout=0.2, go_backwards=True)(z)
    z3 = LSTM(600, dropout=0.1, recurrent_dropout=0.2, go_backwards=False)(conv)
